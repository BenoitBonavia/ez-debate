...
export class MediaCarouselComponent implements AfterViewChecked{
  ...
  ngAfterViewChecked() {
    ...
    this.leftMargin = (this.containerWidth - this.elementsArray[0].nativeElement.offsetWidth) / 2;
    this.rightMargin = (this.containerWidth - this.elementsArray[this.elementsArray.length-1].nativeElement.offsetWidth) / 2;
